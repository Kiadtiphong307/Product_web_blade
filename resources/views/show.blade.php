                            ...
                            @foreach ($products as $product)
                                ...
                                <div class="box rounded-lg ">
                                    ...
                                    <div class="text-center">
                                        <div>
                                            <div class="px-2 py-2 whitespace-nowrap text-xs font-medium text-gray-500"
                                                name="product_id">
                                                รหัสสินค้า : {{ $product->id }}
                                            </div>
                                            <div class="px-2 py-1 whitespace-nowrap text-xs font-medium text-gray-500"
                                                name="product_name">
                                    ...
                                    @if ($product->stock > 0)
                                        <button type="submit" class="btn-add mb-2 mt-2  rounded-lg">
                                            <p class="flex">
                                                ...
                                                <svg class="justify-self-end mt-1 mb-1 rounded-lg"
                                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                    fill="none" stroke="currentColor" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round"
                                                    class="feather feather-shopping-cart rounded-lg">
                                                    <circle cx="9" cy="21" r="1"></circle>
                                                    <circle cx="20" cy="21" r="1"></circle>
                                                    <path
                                                        d="M1 1h4l2.68 13.39a2 2 0 0 0 1.96 1.61h8.72a2 2 0 0 0 1.96-1.61L23 6H6"
